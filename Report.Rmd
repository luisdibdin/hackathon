...
# htmltools::includeHTML("concern_map.html") # need the map from Luis
```

```{r concern_bar, echo=FALSE}
# htmltools::includeHTML("concern_bar.html") # need the map from Luis
```
...
twitter_data <- read.csv("tidy_twitter_data_char_removed.csv")
